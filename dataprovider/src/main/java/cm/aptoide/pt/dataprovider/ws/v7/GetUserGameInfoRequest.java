...
public class GetUserGameInfoRequest extends V7<GetUserGameInfoResponse, GetUserGameInfoRequest.Body> {

  private String url = "http://192.168.1.100:5000/api/7/user/timeline/game/getUserInfo/";

  GetUserGameInfoRequest(String url, GetUserGameInfoRequest.Body body, BodyInterceptor<BaseBody> bodyInterceptor,
  ...
  public static GetUserGameInfoRequest of(String url, BodyInterceptor<BaseBody> bodyInterceptor, OkHttpClient httpClient,
      Converter.Factory converterFactory, TokenInvalidator tokenInvalidator,
      SharedPreferences sharedPreferences) {

    return new GetUserGameInfoRequest(url,
        new GetUserGameInfoRequest.Body(sharedPreferences), bodyInterceptor,
